...
public final class SelectionCreator {
    ...
    private SelectionSpec mSelectionSpec = null;
    ...
    public SelectionCreator cameraOnly(boolean only) {
        mSelectionSpec.cameraOnly = true;
        return this;
    }
     ...
     * storage and also a authority for FileProvider.
     *
