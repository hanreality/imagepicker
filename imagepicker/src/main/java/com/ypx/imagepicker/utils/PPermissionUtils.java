...
public class PPermissionUtils {
    ...
    public static boolean hasStoragePermissions(Activity activity) {
        if (Build.VERSION.SDK_INT >= 23 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU && activity.getApplicationInfo().targetSdkVersion >= Build.VERSION_CODES.TIRAMISU) {
    ...
    public void showSetPermissionDialog(final String msg) {
        ...
        builder.setNegativeButton(context.getString(R.string.picker_str_permission_refuse_setting), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setPositiveButton(context.getString(R.string.picker_str_permission_go_setting), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                gotoPermissionSet();
    ...
    private void gotoMeizuPermission() {
        try {
            ...
            intent.putExtra("packageName", "com.ypx.imagepickerdemo");
